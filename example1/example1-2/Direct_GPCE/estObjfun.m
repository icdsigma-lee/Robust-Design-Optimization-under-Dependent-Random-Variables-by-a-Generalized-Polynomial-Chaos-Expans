...
% 2. options for Gram matrix construction: 'QR' quadrature rule/ 'MC' Monte carlo integration (Quasi MC used)
% mean-values as design variables are updated for paramterized response functions 
function [stat] = estObjfun(dv) 
global cntObj 
double precision;
%% Initialization
